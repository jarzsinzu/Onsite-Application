...
<body>
    <div class="sidebar">
        ...
        <div class="nav-container">
            <div class="nav-links">
                <a href="data-admin.php" class="<?= $current_page == 'data-admin.php' ? 'active' : '' ?>">
                    <i class="bi bi-columns-gap"></i> Dashboard
                </a>
                <!-- <a href="histori-user.php" class="<?= $current_page == 'histori-user.php' ? 'active' : '' ?>">
    ...
    <div class="main">
        <form class="search-bar" method="post">
            <div class="topbar">
                ...
                <div class="profile">
                    <span style="color: #1c1c1c;"><?php echo $_SESSION['user'] = $username;?></span>
